    ...
    with it.having('DA1 parser'):
        ...
        def test_da1_robodoc():
            it.robodoc_fixations = [
                Fixation(
                    Point(6, 0), 1241, 1410, 0,
                    Region(Point(0, 0), Point(17, 0), label=0, number=0)
                ),
                Fixation(
                    Point(4, 0), 1429, 1796, 1,
                    Region(Point(0, 0), Point(17, 0), label=0, number=0)
                ),
                Fixation(
                    Point(16, 0), 1822, 2223, 2,
                    Region(Point(0, 0), Point(17, 0), label=0, number=0)
                ),
                Fixation(
                    Point(6, 0), 2245, 2471, 3,
                    Region(Point(0, 0), Point(17, 0), label=0, number=0)
                ),
                Fixation(
                    Point(24, 0), 2504, 3232, 4,
                    Region(Point(17, 0), Point(29, 0), label=1, number=1)
                ),
                Fixation(
                    Point(32, 0), 3262, 3520, 5,
                    Region(Point(29, 0), Point(40, 0), label=2, number=2)
                ),
                Fixation(
                    Point(39, 0), 3552, 3894, 6,
                    Region(Point(29, 0), Point(40, 0), label=2, number=2)
                ),
                Fixation(
                    Point(44, 0), 3924, 4164, 7,
                    Region(Point(40, 0), Point(52, 0), label=3, number=3)
                ),
                Fixation(
                    Point(55, 0), 4189, 4671, 8,
                    Region(Point(52, 0), Point(65, 0), label=4, number=4)
                ),
                Fixation(
                    Point(49, 0), 4696, 4931, 9,
                    Region(Point(40, 0), Point(52, 0), label=3, number=3)
                ),
                Fixation(
                    Point(69, 0), 4959, 5250, 10,
                    Region(Point(65, 0), Point(77, 0), label=5, number=5)
                ),
                Fixation(
                    Point(65, 0), 5271, 5633, 11,
                    Region(Point(65, 0), Point(77, 0), label=5, number=5)
                ),
                Fixation(
                    Point(72, 0), 5656, 5885, 12,
                    Region(Point(65, 0), Point(77, 0), label=5, number=5)
                ),
                Fixation(
                    Point(81, 0), 5910, 6278, 13,
                    Region(Point(77, 0), Point(95, 0), label=6, number=6)
                ),
                Fixation(
                    Point(87, 0), 6300, 6625, 14,
                    Region(Point(77, 0), Point(95, 0), label=6, number=6)
                ),
                Fixation(
                    Point(81, 0), 6647, 6851, 15,
                    Region(Point(77, 0), Point(95, 0), label=6, number=6)
                ),
                Fixation(
                    Point(78, 0), 6873, 7231, 16,
                    Region(Point(77, 0), Point(95, 0), label=6, number=6)
                ),
                Fixation(
                    Point(87, 0), 7256, 7768, 17,
                    Region(Point(77, 0), Point(95, 0), label=6, number=6)
                )
            ]
