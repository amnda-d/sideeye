...
with such.A("Saccade") as it:
    ...
    def test_saccade_equality():
        it.assertTrue(
            Saccade(10, True, it.fix1, it.fix2) == Saccade(10, True, it.fix1, it.fix2)
        )
        it.assertTrue(
            Saccade(10, False, it.fix1, it.fix2) != Saccade(50, False, it.fix1, it.fix2)
        )
        it.assertTrue(
            Saccade(10, False, it.fix1, it.fix2) != Saccade(10, True, it.fix1, it.fix2)
        )
